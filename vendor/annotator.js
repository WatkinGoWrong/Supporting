...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.loadAnnotations = function(annotations) {
      ...
      // document.cookie = "storedAnnotations" + "=" + JSON.stringify(annotations) + ";" + expires + ";path=/";/////////////

      // var name = "storedAnnotations=";
    ...
    Annotator.prototype.showEditor = function(annotation, location) {
      ...
      // if(initialCheck){
      //   if(currentUrl=="1"){
      //     annotationMapper.url1  = "annotator-field-0";
      //     annotationMapper.url1t = 'annotator-field-1';
      //   }else if(currentUrl=="1t"){
      //     annotationMapper.url1  = "annotator-field-1";
      //     annotationMapper.url1t = 'annotator-field-0';
      //   }
      //   initialCheck=false;
      // }
...
changed last word (textarea) of lines; 189, 223, 308, 347, 356, with div in annotator.css

*

line 800 changed 'textarea' to 'div'
lines 1409, 1410 changed teaxtarea to div

1034 - 1036 where taggle.js is initialized

line 805 saving taggle

Annotator.prototype._setupEditor - Is where taggles are saved as annotation text

Annotator.prototype.showEditor - Is where taggles are initialised, and edited
